...
function PerbaikanMobil({ user }) {
  ...
  const muatData = async () => {
    ...
    try {
      ...
      setErrorMsg(
        'Gagal memuat data perbaikan mobil.'
      )
    } finally {
      setLoading(false)
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        alert(
          pesanValidasi || 'Gagal menyimpan data perbaikan.'
        )
        return
      }
  ...
  return (
    <div className="page">
          ...
          >
            ...
            <div>
              <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Plus size={18} /> Tambah Data Perbaikan
              </h3>
      ...
      <div className="card">
        ...
        <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <ClipboardList size={18} /> Daftar Perbaikan Mobil
        </h3>
